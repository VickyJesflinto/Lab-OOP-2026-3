...
public class Main {
    ...
    static void menuTambahItem() {
        ...
        if (tipe == 1) {
            ...
            Book book = new Book(judul, id, penulis);
            System.out.println();
    ...
    static void menuPinjamItem() {
        ...
        try {
            ...
            if (item.isBorrowed) {
                ...
                success("Item \"" + item.title + "\" berhasil dipinjam oleh " + member.name);
            }
        } catch (NoSuchElementException e) {
            error(e.getMessage());
        } catch (IllegalArgumentException e) {
            // Menangkap pesan error dari Book/DVD jika hari peminjaman melebihi batas
    ...
    static void menuKembalikanItem() {
        ...
        try {
            ...
            try {
                LibraryItem item = library.findItemById(idItem);
                String hasil = member.returnItem(item, hariTelat);
                success(hasil);
                library.logger.logActivity(
